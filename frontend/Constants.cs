...
public static class Constants
{
  ...
  public static string DiscordMembersUrl = Environment.GetEnvironmentVariable("DISCORD_MEMBERS_URL") ?? "https://discord.com/api/invites/424xxTZVYX?with_counts=true";
